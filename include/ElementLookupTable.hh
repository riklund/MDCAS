...
class ElementLookupTable
{
 public:
  ...
  string lookupElement(unsigned short int elementToLookup); //!<Look up a specific element. \return empty string if the element was not found.
 protected:
  ...
  map<unsigned short int, string> myReversedTable; //!<Maps the element numbers to their strings.
};
#endif
